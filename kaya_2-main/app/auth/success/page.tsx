      ...
      <div className="w-full gap-6 flex flex-col items-center justify-center">
        <div className="flex flex-col items-center gap-4 text-center mb-8">
          ...
          <p className="text-[#333232] text-sm md:text-base text-center max-w-[391px]">
            Get ready to experience the easiest parcel delivery service at your
            fingertips!{" "}
          </p>
        </div>
        ...
        <Button
          asChild
          className="w-full bg-[#00ABFD] text-white py-4 rounded-lg text-base font-medium max-w-sm">
          <Link href={"/passenger/home"}>Start Sending</Link>
        </Button>
      </div>
    </AuthForm>
  );
